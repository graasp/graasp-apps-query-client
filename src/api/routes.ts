...
export const buildPatchAppDataRoute = (payload: { itemId: string; id: string }): string =>
  `${APP_ITEMS_ROUTE}/${payload.itemId}/${APP_DATA_ENDPOINT}/${payload.id}`;

export const buildDeleteAppDataRoute = (payload: { itemId: string; id: string }): string =>
  `${APP_ITEMS_ROUTE}/${payload.itemId}/${APP_DATA_ENDPOINT}/${payload.id}`;
...
export const buildPatchAppSettingRoute = (payload: { itemId: string; id: string }): string =>
